...
const variantClasses = (variant) => ({
    ...
    'bg-white border border-gray-300 text-gray-900 hover:bg-gray-50 hover:border-gray-300 disabled:bg-white disabled:border-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:hover:bg-[#1B2530] dark:bg-transparent dark:border-gray-dark-600 dark:text-dark-gray-50 dark:hover:bg-gray-dark-900 dark:disabled:bg-transparent dark:disabled:border-gray-dark-700 dark:disabled:text-gray-dark-700':
